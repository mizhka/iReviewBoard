...
// in simulator we redefine to format for iReviewBoard Developer console
...
{\
	NSString * exceptionName = [@"org.ireviewboard." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ireviewboard";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIiReviewBoardNativeItemNone = -1, 
	UIiReviewBoardNativeItemSpinner = -2,
	UIiReviewBoardNativeItemProgressBar = -3,
	
	UIiReviewBoardNativeItemSlider = -4,
	UIiReviewBoardNativeItemSwitch = -5,
	UIiReviewBoardNativeItemMultiButton = -6,
	UIiReviewBoardNativeItemSegmented = -7,
	
	UIiReviewBoardNativeItemTextView = -8,
	UIiReviewBoardNativeItemTextField = -9,
	UIiReviewBoardNativeItemSearchBar = -10,
	
	UIiReviewBoardNativeItemPicker = -11,
	UIiReviewBoardNativeItemDatePicker = -12,
	
	UIiReviewBoardNativeItemInfoLight = -13,
	UIiReviewBoardNativeItemInfoDark = -14,
	
	UIiReviewBoardNativeItemDisclosure = -15,
	
	UIiReviewBoardNativeItemContactAdd = -16
};
